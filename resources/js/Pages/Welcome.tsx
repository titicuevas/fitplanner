                ...
                <div className="relative z-10">
                    ...
                    <main className="mx-auto max-w-7xl px-6 py-24 text-center">
                        ...
                        <div className="mt-16 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
                            {[
                                { title: 'Seguimiento de Progreso', desc: 'Registra tus WODs y visualiza tu evolución en tiempo real', icon: 'M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z' },
                                { title: 'Programación Semanal', desc: 'Planifica tus entrenamientos y mantén una rutina consistente', icon: 'M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z' },
                                { title: 'Comunidad', desc: 'Conecta con otros atletas y comparte tus logros', icon: 'M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z' },
                            ].map((item) => (
                                <div key={item.title} className="rounded-xl bg-gray-800/50 p-8 shadow-lg backdrop-blur-sm transition-all duration-300 hover:bg-gray-800/70 hover:shadow-red-500/10">
