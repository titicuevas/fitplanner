                ...
                <div className="bg-gray-900/90 px-6 py-8 shadow-[0_0_1rem_rgba(0,0,0,0.3)] backdrop-blur-sm sm:rounded-xl sm:px-12">
                    <form className="space-y-6" onSubmit={submit}>
                        <div>
                            ...
                            {errors.name && <p className="mt-2 text-sm font-medium text-red-400">{errors.name}</p>}
                        </div>
                        ...
                        <div>
                            ...
                            {errors.email && <p className="mt-2 text-sm font-medium text-red-400">{errors.email}</p>}
                        </div>
                        ...
                        <div>
                            ...
                            {errors.password && <p className="mt-2 text-sm font-medium text-red-400">{errors.password}</p>}
                        </div>
                        ...
                        <div>
                            ...
                            {errors.password_confirmation && <p className="mt-2 text-sm font-medium text-red-400">{errors.password_confirmation}</p>}
                        </div>
